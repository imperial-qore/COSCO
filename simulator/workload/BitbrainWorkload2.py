...
class BWGD2(Workload):
    def __init__(self, meanNumContainers, sigmaNumContainers, start_data_point, end_data_point):
        super().__init__()
        self.mean = meanNumContainers
        self.sigma = sigmaNumContainers
        self.start_data_point = start_data_point
        self.end_data_point = end_data_point
        ...
        for i in range(start_data_point, end_data_point):
